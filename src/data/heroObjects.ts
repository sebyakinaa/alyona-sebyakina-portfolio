...
{id:'badge',src:asset('badge'),mobileSrc:mobileAsset('badge'),alt:'Бейдж Алены Себякиной, продуктового дизайнера',depth:.22,className:'hero-object--badge',exit:{x:'0vw',y:'-10vh',rotate:0}},
